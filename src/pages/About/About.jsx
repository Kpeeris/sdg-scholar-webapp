  ...
  return (
    <div data-testid="about-page">
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex flex-col md:w-1/2 justify-center pr-8 pl-8 pb-8">
          <h1 className="leading-[1.2] mb-1">
            Redefining <span className="text-orange-500">SDG Education, </span>
            One Goal at a Time
          </h1>
          <p>
            Discover the United Nations&apos; SDGs like never before! Explore
            each SDGs&apos; worlds—complete quizzes, unlock new places and make
            an impact as you learn and grow
          </p>
        </div>
      ...
      <div className="px-16 pt-12">
        <h2 className="leading-[1.3] mb-1 text-center text-4xl font-bold">
          Dive into the Experience
        </h2>
        <p className="text-center">
          SDG Scholar is designed to make learning about the SDGs fun, engaging,
          and impactful
        </p>
        <FeaturesCards />
      </div>
      ...
      {/* What are the SDGs s */}
      <div
        className="relative h-screen bg-no-repeat bg-center bg-contain flex justify-center items-center"
        style={{
      ...
      >
        ...
        <div className="absolute top-20 w-full">
          <h2 className="leading-[1.3] mb-2 text-center text-4xl font-bold">
            What are the SDGs?
          </h2>
      ...
      <div className="flex flex-col items-center mx-16">
        ...
        <p className="text-center">
          Discover how the SDGs connect to your studies and career across fields
        </p>
        <RelevantSDGAccodian />
      </div>
      ...
      <div className="flex flex-col items-center p-12">
        <h2 className="leading-[1.3] text-center text-4xl font-bold">
          Attributions
        </h2>
        <p className="text-center max-w-4xl">
          ...
          to enhance our site&apos;s visuals and referenced the official{" "}
          <a
          ...
          to develop our content. We also use{" "}
          <a
          ...
          for the text editor in our admin content pages.
        </p>
      </div>
    </div>
  );
