    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
      ...
      <Card>
        <CardContent className="space-y-2">
          ...
          <p>
            Explore immersive worlds for each UN Sustainable Development Goal,
            each filled with engaging content and fun quizzes.
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="space-y-2">
          ...
          <p>
            {" "}
            Complete quizzes to unlock new places and track your progress
            through each SDG Target.{" "}
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="space-y-2">
          ...
          <p>
            {" "}
            Admins have the power to customize content and quizzes, keeping the
            learning experience fresh, relevant, and impactful.{" "}
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="space-y-2">
          ...
          <p>
            {" "}
            Check the Notice Board for important updates, events and real world
            projects from admins.{" "}
          </p>
        </CardContent>
      </Card>
    </div>
